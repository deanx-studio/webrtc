...
<form accept-charset="UTF-8" action="${sign_in}" class="new_user"
	method="post" role="form" class="form-horizontal">
		<div class="control-group">
			<label class="control-label" for="user_login">智旅账户</label>
			<div class="controls">
			<input
			id="user_login" name="j_username" placeholder="账户" type="text" class="form-control" />
			</div>
		</div>
		<div class="control-group">
		<label class="control-label" for="user_password">
			<span class="control-label" style="margin-left:0px;">密码
			<a href="${forget}" style="margin-left:125px;">忘记密码</a></span>
		</label>
		<div class="controls">
			<input id="user_password"
			name="j_password" type="password" id="inputPassword" class="form-control" placeholder="密码"/>
		</div>
			</div>
		<div class="control-group">
			<div class="controls">

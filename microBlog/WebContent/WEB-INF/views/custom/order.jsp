...
<div class="container" style="max-width: 960px;">
	...
	<form class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label><span style="color: gold; font-size: 18px;">￥${salePrice
						}元</span>起<br /> <span style="color: gray">(此价格为不含机票价格，实际价格随出发时参团人数略有变动)</span></label>
		...
		<div class="control-group">
			<label class="control-label">儿童占床位数：</label>
			<div class="controls inline">
				<input id="del" class="" type="button" value="-"
					onclick="chgNumber('childrenBedsCount',-1)"> <input
					type="text" id="childrenBedsCount" class="input-mini" name="number"
					value="${childrenBedsCount }"> <input id="plus" class=""
					type="button" value="+" onclick="chgNumber('childrenBedsCount',1)"><br />
					...
					$.post(url, {
						...
						if (status == 'success') {
							if (result == '0') {
								...
								txtResult.innerHTML = "订单已经生成，订单号:" + result
										+ "有疑问请联系客服：18911837159。";
